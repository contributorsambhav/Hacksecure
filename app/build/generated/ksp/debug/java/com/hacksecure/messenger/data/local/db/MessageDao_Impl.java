  ...
  public MessageDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfMessageEntity = new EntityInsertionAdapter<MessageEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `messages` (`id`,`conversationId`,`senderIdHex`,`ciphertextBlob`,`storageKeyAlias`,`headerJson`,`timestampMs`,`counter`,`expiryMs`,`isDecryptable`,`isOutgoing`,`messageType`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
      }
      ...
      public List<MessageEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new MessageEntity(_tmpId,_tmpConversationId,_tmpSenderIdHex,_tmpCiphertextBlob,_tmpStorageKeyAlias,_tmpHeaderJson,_tmpTimestampMs,_tmpCounter,_tmpExpiryMs,_tmpIsDecryptable,_tmpIsOutgoing,_tmpMessageType);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public MessageEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final String _tmpMessageType;
            _tmpMessageType = _cursor.getString(_cursorIndexOfMessageType);
            _result = new MessageEntity(_tmpId,_tmpConversationId,_tmpSenderIdHex,_tmpCiphertextBlob,_tmpStorageKeyAlias,_tmpHeaderJson,_tmpTimestampMs,_tmpCounter,_tmpExpiryMs,_tmpIsDecryptable,_tmpIsOutgoing,_tmpMessageType);
          } else {
            _result = null;
          }
          return _result;
