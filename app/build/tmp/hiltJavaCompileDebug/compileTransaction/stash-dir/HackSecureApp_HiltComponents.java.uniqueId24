...
import com.hacksecure.messenger.worker.MessageExpiryWorker_HiltModule;
import dagger.Binds;
...
public final class HackSecureApp_HiltComponents {
  private HackSecureApp_HiltComponents() {
  }
  ...
  @Component(
      modules = {
          ...
          MessageExpiryWorker_HiltModule.class
      }
  )
  @Singleton
  public abstract static class SingletonC implements HackSecureApp_GeneratedInjector,
  ...
  @Subcomponent(
      modules = {
          ...
          QrDisplayViewModel_HiltModules.KeyModule.class,
